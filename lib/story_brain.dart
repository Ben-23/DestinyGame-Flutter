...
class StoryBrain {
  ...
  void nextStory(int choiceNumber) {
    if (choiceNumber == 1 && storyIndex == 0) {
      storyIndex = 2;
    } else if (choiceNumber == 2 && storyIndex == 0) {
      storyIndex = 1;
    } else if (choiceNumber == 1 && storyIndex == 1) {
      storyIndex = 2;
    } else if (choiceNumber == 2 && storyIndex == 1) {
      storyIndex = 3;
    } else if (choiceNumber == 1 && storyIndex == 2) {
      storyIndex = 5;
    } else if (choiceNumber == 2 && storyIndex == 2) {
      storyIndex = 4;
    } else if (choiceNumber == 1 && storyIndex == 3) {
      restart();
    } else if (choiceNumber == 1 && storyIndex == 4) {
      restart();
    } else if (choiceNumber == 1 && storyIndex == 5) {
      restart();
    }
  }
  ...
  bool buttonShouldBeVisible() {
    if (storyIndex == 0 || storyIndex == 1 || storyIndex == 2)
      return true;
    else
      return false;
  }
